...
# Écran OLED — WEO128128B

L'écran OLED blanc 128x128 pixels est connecté au processeur applicatif via le bus SPI1 interne. Il utilise le contrôleur SSD1327 et est relié par un connecteur FFC/FPC 24 positions.
