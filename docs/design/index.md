...
| ----------------------------------------- | -------------------------------- | ----------------------------------------- |
| [Alimentation](./power)                   | FCT-01 à FCT-09                  | Batterie, chargeur, jauge, convertisseurs |
| [Interface utilisateur](./user-interface) | FCT-10 à FCT-27                  | Écran, LEDs, boutons, buzzer              |
| [Communication](./communication)          | FCT-28 à FCT-34                  | Bluetooth, radio, flash                   |
| [MCU et stockage](./mcu-storage)          | FCT-35 à FCT-39                  | STM32WB55, mémoire                        |
| [Capteurs](./sensors)                     | FCT-40 à FCT-54                  | 7 capteurs internes, connecteurs externes |
| [Service et USB](./service-usb)           | FCT-55 à FCT-64                  | SWD, DAPLink, USB                         |
| [Contraintes](./constraints)              | ENV-01 à ENV-05, PHY-01 à PHY-03 | Environnement, mécanique                  |

## Voir aussi

- [Hardware](../hardware/) — Description du matériel
- [Schémas](../hardware/schematic) — Fichiers Altium et PDF
